class studio::langs::go (
  ...
  package { 'pandoc':
    ...
    environment => ['BUILDER_NAME=pakkunbot', 'BUILDER_EMAIL=blah+pakkun@cliffano.com', 'HOME=/root', 'GOPATH=/root/go', 'GOOS=linux', 'GOARCH=amd64', 'GOCACHE=/root/.cache/go-build'],
    cwd         => '/tmp/checkmake',

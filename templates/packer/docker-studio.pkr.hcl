...
source "docker" "studio" {
  ...
  changes = [
    ...
    "ENV PATH /root/.cargo/bin:/root/.local/bin:/root/go/bin:.venv/bin:.poetry/bin:/opt/poetry-venv/bin:/opt/poetry/bin:/usr/local/go/bin:/usr/local/maven/bin:/usr/local/node/bin:/usr/local/openjdk-jdk/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin"
  ]
}
